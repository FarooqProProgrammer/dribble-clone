...
const Freelance = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Post Freelance Projects | Hire Top Freelancers | Dribbble</title>
        <meta name="description" content="Post your freelance projects and connect with top designers. Find the perfect freelancer for your project on Dribbble." />
      </Helmet>
      <motion.div
