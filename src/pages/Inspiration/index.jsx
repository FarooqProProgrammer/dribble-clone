...
const Inspiration = () => {
  ...
  const inspirationItems = [
    { id: 1, title: 'Modern Dashboard', category: 'Web Design', image: 'https://placehold.co/600x400' },
    { id: 2, title: 'Mobile App UI', category: 'Mobile', image: 'https://placehold.co/600x400' },
    { id: 3, title: 'Landing Page', category: 'Web Design', image: 'https://placehold.co/600x400' },
    { id: 4, title: 'Brand Identity', category: 'Branding', image: 'https://placehold.co/600x400' },
  ];

  return (
    <>
    <Helmet>
      <title>Inspiration | Dribble</title>
    </Helmet>
